...
This project provides a Docker container for [Video Duplicate Finder](https://github.com/0x90d/videoduplicatefinder).
...
[Releases]: https://github.com/jlesage/docker-video-duplicate-finder/releases
[Docker Hub]: https://hub.docker.com/r/jlesage/video-duplicate-finder/tags
...
container, it would proxy all HTTP requests for `video-duplicate-finder.domain.tld` to
...
| **Application version** label | Displays the version of Video Duplicate Finder integrated into Docker image. |
...
Any desktop notification generated by Video Duplicate Finder is forwarded to the
